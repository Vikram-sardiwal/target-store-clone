      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <main className="lg:col-span-3 bg-white rounded-2xl shadow-md p-5 sm:p-6 md:p-8">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-lg w-full sm:w-auto">
              Save Changes
            </button>

            <button
              onClick={() => console.log(data)}
              className="border px-6 py-3 rounded-lg hover:bg-gray-100 w-full sm:w-auto"
            >
              Cancel
            </button>
          </div>
